...
namespace COAL
{
    namespace File
    {
        ...
        {
            bool Result;
            std::ofstream Filewriter(Filepath, (std::_Ios_Openmode)(std::ios::binary | (Append ? std::ios::app : 0)));
            Result = !!Filewriter.write((const char *)Databuffer, ssize_t(Datalength));
            Filewriter.close();
            return Result;
        }
        ...
        bool Read(const char *Filepath, void *Databuffer, size_t *Datalength)
        {
            ...
            bool Result = !!Filereader.read((char *)Databuffer, ssize_t(Readsize));
...
#include <dirent.h>
        ...
        bool List(std::string Searchpath, std::vector<std::string> *Filenames, const char *Extension)
        {
        ...
        bool Listrecursive(std::string Searchpath, std::vector<std::string> *Filenames, const char *Extension)
        {
